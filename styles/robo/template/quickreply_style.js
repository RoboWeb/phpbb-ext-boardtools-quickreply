...
(function ($, window, document) {
  ...
  quickreply.style.initPreview = function () {
    quickreply.$.mainForm.before(
      '<div id="preview" class="post" style="display: none;"><article class="postbody"><h3></h3><i id="preview_close" class="fas fa-times"></i><div class="post-content"></div></article></div>'
    );
  };
  ...
  quickreply.style.showQuickReplyForm = function () {
    console.log("quickreply_style.js/showQuickReplyForm", $("#reprap"));
    /*****************************/
  ...
  quickreply.style.bindPagination = function () {
    if (quickreply.settings.saveReply) {
      $('.pagination a:not(.dropdown-trigger, .mark[href="#unread"])').click(
        function (event) {
    ...
    $('.pagination a.mark[href="#unread"]').click(function (event) {
      event.preventDefault();
    ...
    $(".pagination .page-jump-form :button").click(function () {
      var $input = $(this).siblings("input.inputbox");
      quickreply.functions.pageJump($input);
    });

    $(".pagination .page-jump-form input.inputbox").on("keypress", function (
      event
    ) {
    ...
    $(".pagination .dropdown-trigger").click(function () {
  ...
  quickreply.style.initPagination = function () {
    $(window).on("load", function () {
      $(".pagination").find(".page-jump-form :button").unbind("click");
      $(".pagination").find(".page-jump-form input.inputbox").off("keypress");
  ...
  quickreply.style.getPostId = function (element) {
    return element.parents(".post").prev().attr("id").replace("p", "");
  };
  ...
  quickreply.style.responsiveQuotesOnClick = function (elements, fn) {
    elements
      .find(".post-buttons .responsive-menu")
      .on("click", "a:has(.fa-quote-left)", fn);
  };
