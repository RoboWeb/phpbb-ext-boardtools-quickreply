  ...
  function QuickNick() {
    ...
    function quickNickHandlePosts(e, elements) {
      elements.find(nicknameSelector).each(function () {
        $(this).attr("title", quickreply.language.QUICKNICK_TITLE);
      });
      //   elements
    ...
    self.init = function () {
      if (quickNickIsDropdown()) {
        console.log("Kto jeszcze marzy o dropdown pod nazwą usera?");
      }
      ...
      if (quickNickIsString()) {
        ...
        quickreply.$.qrPosts.on("click", ".username-coloured", function (e) {
          e.preventDefault();
          var $nickname = $(this);
          self.insert($nickname);
        });
