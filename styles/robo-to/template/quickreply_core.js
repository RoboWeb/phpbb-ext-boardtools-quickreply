...
(function ($, window, document) {
  ...
  function Loading() {
    ...
    this.init = function () {
      $("#darkenwrapper").after(
        '<div id="qr_loading_text"><div id="loading_indicator"></div><span></span><div id="qr_loading_explain"></div>' +
  ...
  function QrForm() {
    ...
    function addToggleButton() {
      var $toggle = $(
        '<div id="qr_show_fixed_form"><i class="fa fa-fw fa-comment"></i><span>' +
          quickreply.language.QUICKREPLY +
          "</span></div>"
      )
        .click(function () {
    ...
    function exitExtended() {
      ...
      $(
        "#qr_action_box, #qr_text_action_box, #qr_captcha_container, .submit-buttons"
      ).show();
    ...
    this.exitFullscreen = function () {
      ...
      $(".qr_fullscreen_button")
        .toggleClass("fa-arrows-alt fa-times")
        ...
        quickreply.$.mainForm
          ...
          .submit(function () {
            ...
            var $clickedButton = $(this).find(
              'input[type="submit"][data-clicked]'
            );
